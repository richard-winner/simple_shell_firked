...
/**
 * add_node_end - function here adds a node to the end of the list
 * @head: the address of pointer to head node
 * @str: the str field of node
 * @num: the node index used by history
 * Return: should return the size of list
 */
...
/**
 * print_list_str - function prints only the str element of list_t linked list
