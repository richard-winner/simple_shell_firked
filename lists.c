...
/**
 * print_list_str - this function prints only the str element
...
/**
 * delete_node_at_index - funcion deletes node at given index
...
/**
 * free_list - function here frees all nodes of a list
