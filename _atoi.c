...
/**
 * is_delim - the function checks if character is delimeter
...
/**
 * _isalpha - function here checks for alphabetic character
...
/**
 * _atoi - function here converts a string to an integer
