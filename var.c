...
/**
 * is_chain - test to check if current char in buffer is a chain delimeter
...
/**
 * check_chain - test to check if we should continue
...
/**
 * replace_vars - in the tokenized string it replaces vars
 * @info: struct parameter
 * Return: returns 1 if replaced, otherwise returns 0
 */
