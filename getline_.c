...
/**
 * get_input - the function here gets a line minus the newline
...
/**
 * _getline - function here gets the next line of input from STDIN
 * @info: tyhis is the parameter struct
